...
<body>
  <div class="container">
    <h1 class="text-danger text-center">## Exercice 2  Partie 4</h1>
    <h2>
    ...
    <?php 
        // je crée un tableau associatif (clé => valeur) 
        $languages = ['1' => 'HTML/CSS', '2' => 'JS', '3'=> 'PHP', '4'=> 'Python', '5' => 'Java'];
        
            foreach ($languages as $programs){
                ?>
                <p class="mt-4 text-center">
                    <?='J\'affiche seulement les valeurs de mon tableau : ' . $programs ?>
                </p>
                <?php
            }
    ?>
